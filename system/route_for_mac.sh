...
route -n delete -net 10.0.0.0/8 172.16.99.1
route -n delete -net 172.17.0.0/16 172.16.99.1
route -n delete -net 172.32.0.0/16 172.16.99.1
...
route -n add -net 10.0.0.0/8 172.16.99.1
route -n add -net 172.17.0.0/16 172.16.99.1
route -n add -net 172.32.0.0/16 172.16.99.1
